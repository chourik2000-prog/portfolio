<template>
    <div>
        <div class="flex justify-center row-full mt-12">
            <div class="brightness-20 basis-1/2 p-4 shadow-lg shadow-cyan-500/50 rounded-l-lg border-1 border-indigo-600"> 
                <p class="text-center mt-2 font-bold">
                    le web est un domaine à vision
                </p>
                <div class="brightness-20 basis-1/2 p-4 shadow-lg shadow-cyan-500/50 rounded-l-lg border-1 border-indigo-600"> 
                    <p class="text-justify mt-2 text-sm">
                        <div>
                            ...
                            des applications et des services qui permettront aux individus et aux entreprises
